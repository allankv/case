      ...
      Original.find({limit:1,offset:offset}, function (err, original) {
        ...
        BDQToolkitOutput.find({where:{id:rt.id}}, function (err, bdq) {
          ...
          */
          ...
          assertions.measures.cd1.specification = 'Calculate the average of the number of characters after "." of dwc:decimalLatitude and dwc:decimalLongitude. Applicable to Darwin Core based single records.';
          ...
          assertions.measures.cd2.specification = 'Check if values (disregarding extra spaces) for both dwc:decimalLatitude and dwc:decimalLongitude are different to zero and different to empty. Applicable to Darwin Core based single records.';
          ...
          assertions.measures.cd7.specification = 'Check if values (disregarding extra spaces) for both dwc:scientificName and dwc:scientificNameAuthorship are different to empty. Applicable to Darwin Core based single records.';
          ...
          assertions.measures.cd11.specification = 'Check if value (disregarding extra spaces) for dwc:eventDate is different to empty. Applicable to Darwin Core based single records.';
          ...
          assertions.validations.cc1.specification = 'Check if the average of the number of characters after "." of dwc:decimalLatitude and dwc:decimalLongitude is higher than 4. Applicable to Darwin Core based single records.';
          ...
          assertions.validations.cc2.specification = 'Check if values (disregarding extra spaces) for both dwc:decimalLatitude and dwc:decimalLongitude are different to zero and different to empty. Applicable to Darwin Core based single records.';
          ...
          assertions.validations.cc7.specification = 'Check if values (disregarding extra spaces) for both dwc:scientificName and dwc:scientificNameAuthorship are different to empty. Applicable to Darwin Core based single records.';
          ...
          assertions.validations.cc11.specisfication = 'Check if value (disregarding extra spaces) for dwc:eventDate is different to empty. Applicable to Darwin Core based single records.';
          ...
          assertions.validations.cc15.specification = 'Check if values (disregarding extra spaces) for both dwc:decimalLatitude and dwc:decimalLongitude are different to zero or empty and values for dwc:eventDate, dwc:scientificName and dwc:scientificNameAuthorship are different to empty. Applicable to Darwin Core based single records.';
          ...
          assertions.validations.cc17.specification = 'Check if dwc:eventDate is according to ISO 8601 standard specification. See details in: http://momentjs.com/docs/. Applicable to Darwin Core based single records.';
        ...
        FPAkkaOutput.find({where:{id:rt.id}}, function (err, akka) {
          ...
          */
          ...
          assertions.validations.cc3.specification = 'Check if dwc:decimalLatitude and dwc:decimalLongitude values are consistent with coordinates ranges (latitudes range from -90 to 90 and longitudes range from -180 to 180) and are consistent with the bounds of dwc:country or close enough (currently defined as 200 km) from the georeference for dwc:country, dwc:stateProvince, dwc:county and dwc:locality. Applicable to Darwin Core based single records.';
          ...
          assertions.measures.cd8.specification = 'Check against nomenclature authorities if there is an exact match with both dwc:scientificName and dwc:scientificNameAuthorship values. Applicable to Darwin Core based single records.';
          ...
          assertions.validations.cc8.specification = 'Check against nomenclature authorities if there is an exact match with both dwc:scientificName and dwc:scientificNameAuthorship values. Applicable to Darwin Core based single records.';
          ...
          assertions.measures.cd12.specification = 'Check if dwc:eventDate value is correctly formatted according to ISO 8601 standard and is before dwc:modified and within life span of dwc:collectedBy. Applicable to Darwin Core based single records.';
          ...
          assertions.validations.cc12.specification = 'Check if dwc:eventDate value is correctly formatted according to ISO 8601 standard and is before dwc:modified and within life span of dwc:collectedBy. Applicable to Darwin Core based single records.';
          ...
          assertions.validations.cc18.specification = 'Check if dwc:decimalLatitude and dwc:decimalLongitude values are consistent with coordinates ranges (latitudes range from -90 to 90 and longitudes range from -180 to 180) and are consistent with the bounds of dwc:country or close enough (currently defined as 200 km) to the georeference for dwc:country, dwc:stateProvince, dwc:county and dwc:locality and if dwc:eventDate value is correctly formatted according to ISO 8601 standard and is before dwc:modified and within life span of dwc:collectedBy and if there is an exact match with both dwc:scientificName and dwc:scientificNameAuthorship values with nomenclature authorities. Applicable to Darwin Core based single records.';
          ...
          akka[0].ActorDetails.forEach(function (item) {
            if(item["Actor Result"] == 'CURATED'){
              if(item["Actor Name"] == 'ScientificNameValidator'){
                ...
                assertions.improvements.ce1.specification = 'Recommend the most similar and valid Scientific Name and Scientific Name Authorship according to nomenclature authorities based on string similarity algorithms and in nomenclature rules and conventions. Details can be found at: http://sourceforge.net/p/filteredpush/svn/HEAD/tree/trunk/FP-Tools/FP-CurationServices/src/main/java/edu/harvard/mcz/nametools/. Applicable to Darwin Core based single records.';
