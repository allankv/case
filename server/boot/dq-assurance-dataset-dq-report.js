module.exports = function(app) {
  ...
  if(ACTIVE){
    ...
    var rt = {}
    rt.id = 'http://'+app.host+':3010/api/v1.0/DQReportControls';
    rt.resourceType = "Dataset";
    rt.value = 'http://'+app.host+':3010/api/v1.0/DQReportControls';
    var assertions = {}
    assertions.id = rt.id;
    ...
    var assert = function(offset){
        DQReportAssurance.find({limit:1000,offset:offset}, function (err, report) {
    ...
    function finishing(){
      assertions.dataResource.count = count;

      assertions.measures.cd10.assertion = assertions.measures.cd10.assertion/assertions.dataResource.count;
      assertions.measures.cd5.assertion = assertions.measures.cd5.assertion/assertions.dataResource.count;
      assertions.measures.cd14.assertion = assertions.measures.cd14.assertion/assertions.dataResource.count;

      assertions.measures.cd4.assertion = assertions.measures.cd4.assertion/assertions.dataResource.count;
      assertions.measures.cd6.assertion = assertions.measures.cd6.assertion/assertions.dataResource.count;
      assertions.measures.cd9.assertion = assertions.measures.cd9.assertion/assertions.dataResource.count;
      assertions.measures.cd13.assertion = assertions.measures.cd13.assertion/assertions.dataResource.count;
      assertions.measures.cd16.assertion = assertions.measures.cd16.assertion/assertions.dataResource.count;
      assertions.measures.cd18.assertion = assertions.measures.cd18.assertion/assertions.dataResource.count;
      // Validation
      ...
      assertions.validations.cc19.assertion = assertions.measures.cd18.assertion==1?'Compliant':'Not Compliant';
    ...
    function saveDQReport(assertion){
      DQReportAssurance.upsert(assertion, function (err, dqreport) {
