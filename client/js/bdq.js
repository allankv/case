...
function original(){
var url = "/api/v1.0/DQReports/http%3A%2F%2Flocalhost%3A3010%2Fapi%2Fv1.0%2FOrginalData%2F";
measure(url);
url = "/api/v1.0/DQReports";
records(url);
}
function control(){
var url = "/api/v1.0/DQReportControls/http%3A%2F%2Flocalhost%3A3010%2Fapi%2Fv1.0%2FOrginalData";
measure(url);
url = "/api/v1.0/DQReportControls";
records(url);
}
function assurance(){
var url = "/api/v1.0/DQReportAssurances/http%3A%2F%2Flocalhost%3A3010%2Fapi%2Fv1.0%2FDQReportControls";
measure(url);
